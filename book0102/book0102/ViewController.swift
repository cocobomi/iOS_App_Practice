...
//  book0102
//
//  Created by donghyeon on 2022/01/02.
//
...
/**
    여가에 작성되는 텍스트는 Description 부분에 표기됩니다.
 
    텍스트 간에 한줄을 비워놓으면 줄바꿈이 됩니다.
    ...
    * 이렇게도 됩니다
    ...
    눈치채셨겠지만 앞에 붙는 번호는 크게 중요하지 않습니다. 자동을 번호를 매겨주죠
    ...
    엔터바 또는 별표를 사용하여 텍스트를 강조할 수 있습니다.
 
    텍스트를 기울이고 싶으면 *A pair of marks*를 사용하고
 
    텍스트를 굵게 표시하고 싶으면 **Two pair of marks**를 사용하면 됩니다.
    ...
    다른 텍스트보다 네 칸 이상 들여쓰기하면 코드 블록을 만들어줍니다. 또한 강세표(backquote, ₩)를 세 개 이상 한 쌍으로 묶여도 코드 불록을 만들어줍니다.
    ...
    Precondition, Postcondition, Requires, Invariant, Complexity, Important 등의 키워드를 통해 적절한 정보를 제공해보세요.
